...
(function() {
    ...
    const colors = {
        ...
        red: { gradient: 'radial-gradient(#230000 0%, #000000 100%)', color: '#2d000059', colorTwo: '#2d000059', customCss: `.BattleTabStatisticComponentStyle-containerInsideResults::before, .BattleTabStatisticComponentStyle-containerInsideTeams::before, .Common-entranceGradient::before, #app-root::before, .Common-container::before {
    content: "";
    position: absolute;
    inset: 0;
...
.BattleTabStatisticComponentStyle-containerInsideResults::before, .BattleTabStatisticComponentStyle-containerInsideTeams::before {
    ...
    will-change: transform, opacity;
        ...
        blue: { gradient: 'radial-gradient(#000623 0%, #000000 100%)', color: '#00132d59', colorTwo: '#00132d59', customCss: `.Common-entranceGradient::before, #app-root::before, .Common-container::before {
    content: "";
    position: absolute;
    inset: 0;
...
.BattleTabStatisticComponentStyle-containerInsideResults::before, .BattleTabStatisticComponentStyle-containerInsideTeams::before {
    ...
    will-change: transform, opacity;
        ...
        green: { gradient: 'radial-gradient(#002314 0%, #000000 100%)', color: '#022d0059', colorTwo: '#022d0059', customCss: `.Common-entranceGradient::before, #app-root::before, .Common-container::before {
    content: "";
    position: absolute;
    inset: 0;
...
.BattleTabStatisticComponentStyle-containerInsideResults::before, .BattleTabStatisticComponentStyle-containerInsideTeams::before {
    ...
    will-change: transform, opacity;
        ...
        yellow: { gradient: 'radial-gradient(#212300 0%, #000000 100%)', color: '#2c2d0059', colorTwo: '#2c2d0059', customCss: `.Common-entranceGradient::before, #app-root::before, .Common-container::before {
    content: "";
    position: absolute;
    inset: 0;
...
.BattleTabStatisticComponentStyle-containerInsideResults::before, .BattleTabStatisticComponentStyle-containerInsideTeams::before {
    ...
    will-change: transform, opacity;
        ...
        pink: { gradient: 'radial-gradient(#200023 0%, #000000 100%)', color: '#29002d59', colorTwo: '#29002d59', customCss: `.Common-entranceGradient::before, #app-root::before, .Common-container::before {
    content: "";
    position: absolute;
    inset: 0;
...
.BattleTabStatisticComponentStyle-containerInsideResults::before, .BattleTabStatisticComponentStyle-containerInsideTeams::before {
    ...
    Object.keys(colors).forEach(color => {
        ...
        button.style.borderRadius = '1.3em';
